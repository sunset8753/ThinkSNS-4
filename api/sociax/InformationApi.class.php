    ...
    public function readInformation()
    {
        ...
        if ($id) {
            ...
            if ($information) {
                ...
                $information['content'] = '<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
  <meta name="viewport" content="width=device-width, height=device-height, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no, minimal-ui">
  <title>'.htmlspecialchars($information['subject'], ENT_QUOTES, 'UTF-8').'</title>
  <style type="text/css">
    * {
      box-sizing: border-box;
      margin: 0;
...
<body>
<div class="wrap">
  <div class="abstract"><strong>[摘要]&nbsp;</strong>'.htmlspecialchars($information['abstract'], ENT_QUOTES, 'UTF-8').'</div>
  <div class="content">
    '.$information['content'].'
  </div>
</div>
