 ...
 * @date   2016-09-30
 *
 * @param string $unionid 户在当前钉钉开放平台账号范围内的唯一标识
 *
 * @return stdClass
 */
function dingtalk_get_userid_unionid($unionid)
{
    $params = array(
        'unionid' => $unionid,
    );

    return DingTalk::get_dingtalk_api_response('/user/getUseridByUnionid', $params);
}
