...
class Subject extends Model
{
     ...
     * @var array
     **/
    protected $fields = array('id', 'cid', 'subject', 'abstract', 'content', 'author', 'ctime', 'rtime', 'hits', 'isPre', 'isDel', 'isTop', 'isIndex');
    ...
    {
        $this->_data['isIndex'] = $isIndex ? 1 : 0;
     ...
     * @param  int    $isTop   是否是首页推荐
     * @param  array  $uids    用户列表
     * @return array
     * @author Seven Du <lovevipdsw@vip.qq.com>
     **/
    public function getAdminData($num = 20, $id = '', $cid = '', $subject = '', $isPre = '', $isTop = '', $isIndex = '', array $uids = array())
    {
        $sql = '`isDel` != 1';
        $where = array();
        ...
        $isIndex && array_push($where, '`isIndex` = 1');
